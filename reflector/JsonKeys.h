...
struct SJsonKeys {
	...
	struct FILES { const std::string pid, xml, json, white, black, interlink, terminal, dhtsave; }
	files { "pidFilePath", "xmlFilePath", "jsonFilePath", "whitelistFilePath", "blacklistFilePath", "interlinkFilePath", "g3TerminalFilePath", "dhtSavePath" };
};
